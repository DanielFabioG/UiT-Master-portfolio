...
$$
b2 = \frac{\sum_{i=1}^n(x_i-\bar{x})(y_i-\bar{y})}   {\sum_{i=1}^n(x_i-\bar{x})^2} \ \ , \ \ \ \ \ \ \ \  b_1 = \bar{y} - \beta_2 \bar{x}
$$
...
#' Interpretation: Intercept, when income(x) is equal to zero, the average food 
#' expenditure is $ 83.42. Income: when income increase by 1 unit ($100), the average food expenditure increase by $ 10.21. Or when income decrease by 1 unit ($100), the average food expenditure decrease by $ 10.21
...
-   The SRM can be applied to estimate the parameters of many relationships in economics, business, and the social sciences
...
> predict the value of one variable given the value of another then least squares regression is a tool to consider

------------------------------------------------------------------------

## Assessing the Least Squares Estimators

-   We call $b_1$ and $b_2$ are the least squares estimators.
